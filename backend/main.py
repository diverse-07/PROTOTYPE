...
try:
    from backend.routers import weather, alerts, risk, analytics, reports, ble_bridge
    from backend.database import Base, engine
    import backend.seed as seed_module
except ImportError:
    from routers import weather, alerts, risk, analytics, reports, ble_bridge
...
app.include_router(ble_bridge.router, prefix="/api")
